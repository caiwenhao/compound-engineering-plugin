...
| Skill | Description |
|-------|-------------|
| `/ce-flow` | Intelligent workflow orchestrator — gates workspace setup, reviews docs, prototypes UI work, and routes to the correct phase |
...
| [`ce-ship`](../../docs/skills/ce-ship.md) | Run final checks, then hand off to commit, push, PR, and learning capture |
